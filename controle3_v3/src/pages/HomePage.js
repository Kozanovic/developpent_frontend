...
const HomePage = () => {
  const { utilisateurConnecte, cars } = useSelector((state) => state);
  ...
  const [afficherMessageBienvenue, setAfficherMessageBienvenue] =
    useState(false);
  ...
  return (
    <div className="home-page">
      <section className="hero-section">
        ...
        <p>
          Découvrez le Maroc, roulez avec Maghreb Drive. Trouvez la voiture
          parfaite pour votre prochain voyage. Nous proposons une large gamme de
      ...
      <section className="services-section">
        ...
        <div className="services-grid">
          <div className="service-card">
            ...
            <p>
              Louez une voiture pour quelques heures ou quelques jours. Parfait
          ...
          <div className="service-card">
            ...
            <p>
              Besoin d'une voiture pour plusieurs semaines ou mois ? Nous avons
          ...
          <div className="service-card">
            ...
            <p>
              Découvrez notre sélection de voitures haut de gamme pour des
              occasions spéciales.
            </p>
          </div>
        </div>
      ...
      <section className="about-section">
        ...
        <p>
          Nous nous engageons à vous offrir un service de qualité, des tarifs
          compétitifs et une expérience client exceptionnelle. Notre équipe est
          à votre disposition pour vous aider à trouver la voiture idéale.
        </p>
      </section>
    </div>
  );
